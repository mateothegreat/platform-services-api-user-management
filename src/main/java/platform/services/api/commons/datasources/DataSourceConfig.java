...
package platform.services.api.commons.datasources;
...
//    }
    ...
    @Bean(name = UsersConfig.DATA_SOURCE_PLATFORM_BASE_BEAN_NAME)
    public DriverManagerDataSource platformBaseDataSource() {
        ...
        managerDataSource.setDriverClassName(UsersConfig.DATA_SOURCE_PLATFORM_BASE_DRIVER);
        managerDataSource.setUrl(UsersConfig.DATA_SOURCE_PLATFORM_BASE_URL);
        managerDataSource.setUsername(UsersConfig.DATA_SOURCE_PLATFORM_BASE_USER);
        managerDataSource.setPassword(UsersConfig.DATA_SOURCE_PLATFORM_BASE_PASS);
...
//    }
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        factory.setPackagesToScan(UsersConfig.PLATFORM_SERVICES_API_USERS);
...
//import java.util.Properties;
//
//import AuditingDateTimeProvider;
//import AuditorAwareable;
//import CurrentTimeDateTimeService;
...
////    The PageableHandlerMethodArgumentResolver extracts the information of the requested page from the request.
//
////@ComponentScan(basePackages = { "main.platform.services.api.users", "main.platform.services.api.*", "main.platform.services.api.users.services"})
//public class DataSourceConfig {
//
//    @Autowired
//    protected Environment environment;
